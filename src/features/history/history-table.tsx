...
import { ArrowLeftRight, Coins, Split, TrendingDown, TrendingUp } from 'lucide-react'
    ...
    <div className="space-y-5">
      ...
      {visible.length === 0 ? (
        ...
        <div className="overflow-hidden rounded-xl border border-line bg-surface">
          <div className="grid grid-cols-[1.6fr_1.1fr_1fr_0.9fr_1fr] gap-4 border-b border-line px-5 py-3">
...
function HistoryRow({ entry }: { entry: HistoryEntry }) {
  ...
  return (
    <div className="grid grid-cols-[1.6fr_1.1fr_1fr_0.9fr_1fr] items-center gap-4 px-5 py-3 transition-colors duration-[180ms] hover:bg-raised/50">
